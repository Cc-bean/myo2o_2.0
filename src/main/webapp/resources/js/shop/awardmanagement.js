$(function() {
	// 获取该店铺下的奖品列表URL
	var listUrl = '/myo2o/shopadmin/listawardsbyshop?pageIndex=1&pageSize=9999';
	// 设置奖品的可见状态
	var changeUrl = '/myo2o/shopadmin/modifyaward';
	getList();
	function getList() {
		// 访问后台，获取奖品列表
			...
			.on(
					...
					function(e) {
						...
						if (target.hasClass('edit')) {
							...
							window.location.href = '/myo2o/shopadmin/awardoperation?awardId='
	...
	// 给新增按钮绑定点击事件
	$('#new').click(function() {
		window.location.href = '/myo2o/shopadmin/awardoperation';
	});
