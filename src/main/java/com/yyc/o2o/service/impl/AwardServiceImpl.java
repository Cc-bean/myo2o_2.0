...
import com.yyc.o2o.dao.AwardDao;
import com.yyc.o2o.dto.AwardExecution;
import com.yyc.o2o.entity.Award;
import com.yyc.o2o.enums.AwardStateEnum;
import com.yyc.o2o.exceptions.AwardOperationException;
import com.yyc.o2o.service.AwardService;
...
public class AwardServiceImpl implements AwardService {
	...
	// 2.更新tb_award的信息
	public AwardExecution modifyAward(Award award, CommonsMultipartFile  thumbnail) throws IOException {
		// 空值判断
	...
	private void addThumbnail(Award award, CommonsMultipartFile  thumbnail) throws IOException {
		...
		String thumbnailAddr = ImageUtil.generateThumbnaile(thumbnail,dest);
