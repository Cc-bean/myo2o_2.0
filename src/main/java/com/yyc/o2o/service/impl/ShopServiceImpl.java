...
import com.yyc.o2o.dao.ShopAuthMapDao;
...
import com.yyc.o2o.exceptions.ShopAuthMapOperationException;
    ...
    public ShopExecution addShop(Shop shop, CommonsMultipartFile shopImg) {
        ...
        try {
            ...
            if (effectedNum<=0){//当插入失败时，则抛出runtimeException,结束事务
                LOG.error("插入店铺信息时，返回0条变更"+shop.getShopName());
                ...
                if(shopImg!=null){//当照片不为空时则添加图片
                    ...
                    try{
                        ...
                        if(effectedNum<=0){
                            ...
                            throw new ShopAuthMapOperationException("授权创建失败");
                        }
                        }catch (Exception e){
                        LOG.error("addshop error:"+e.getMessage());
                        throw new ShopAuthMapOperationException("创建店铺失败，请联系相关管理员");
                    }
                }
            }
